...
serve(async (req) => {
  ...
  try {
    ...
    const { accountNumber, ifscCode, applicationId, orgId, verifieduToken: bodyToken, verifieduCompanyId: bodyCompanyId, verifieduBaseUrl: bodyBaseUrl } = await req.json();
