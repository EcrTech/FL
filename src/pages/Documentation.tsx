      ...
      <div className="space-y-4">
        ...
        <div className="border-l-4 border-green-500 pl-4">
          ...
          <ul className="text-sm space-y-1 text-muted-foreground">
            ...
            <li>• WhatsApp messaging via Gupshup API</li>
        ...
        <div className="border-l-4 border-orange-500 pl-4">
          ...
          <ul className="text-sm space-y-1 text-muted-foreground">
            <li>• <strong>Exotel</strong> - Cloud telephony for calling</li>
            <li>• <strong>Gupshup</strong> - WhatsApp Business API</li>
      ...
      <div className="space-y-3 text-sm">
        ...
        <div className="p-3 bg-muted rounded-lg">
          ...
          <p className="text-muted-foreground mt-1">
            ...
            External API (Gupshup/Resend) → Status Update → Analytics Recording
          </p>
        </div>
        <div className="p-3 bg-muted rounded-lg">
...
const ApiReference = () => (
  ...
  "contactId": "uuid" (optional)
        ...
        <div className="border-l-4 border-teal-500 pl-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">Send WhatsApp message via Gupshup</p>
          <div className="bg-muted p-3 rounded text-xs">
            <div className="font-semibold mb-1">Request Body:</div>
            <pre>{`{
  "phoneNumber": "string",
    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="border-l-4 border-blue-500 pl-4">
          ...
          <p className="text-sm text-muted-foreground mb-2">Receive WhatsApp messages from Gupshup</p>
        </div>
      </div>
    </Card>
...
const Integrations = () => (
  <div className="space-y-8">
    ...
    <Card className="p-6">
      <h3 className="text-xl font-semibold mb-4">Gupshup (WhatsApp Business API)</h3>
      <div className="space-y-4">
        <div>
          <h4 className="font-semibold mb-2">Overview</h4>
          <p className="text-sm text-muted-foreground">
            WhatsApp Business API provider for template messages and conversations
          </p>
        </div>
        ...
        <div>
          ...
          <div className="bg-muted p-4 rounded text-sm">
            <div className="grid grid-cols-2 gap-3">
              <div><strong>App Name:</strong> Business app identifier</div>
              <div><strong>API Key:</strong> Required</div>
              <div><strong>Phone Number:</strong> WhatsApp number</div>
              <div><strong>Webhook URL:</strong> For incoming messages</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-2">
            Sync approved templates from Gupshup dashboard
          </p>
          <div className="bg-muted p-3 rounded text-xs font-mono">
            <pre>{`POST /sync-gupshup-templates
POST /create-gupshup-template`}</pre>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {["Template messages", "Text messages", "Media messages", "Interactive buttons", "List messages", "Location messages"].map((type) => (
...
supabase functions deploy`}</pre>
        ...
        <div className="border-l-4 border-orange-500 pl-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="bg-muted p-3 rounded text-xs">
              {["RESEND_API_KEY", "EXOTEL_API_KEY", "EXOTEL_API_TOKEN", "GUPSHUP_API_KEY", "LOVABLE_API_KEY"].map((secret) => (
