    ...
    <div className="bg-background text-foreground p-6 max-w-4xl mx-auto print:p-4 print:text-[11px]">
      ...
      <div className="mb-6" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
        ...
        <div className="text-sm space-y-3">
          <p>
            Whereas, paisaasaarthi.com is an online loan origination platform of PAISAA SAARTHI FINTECH PVT LTD that markets personal loan product to borrowers. The Service Provider has entered into a Service Agreement with the Lender to originate and process loan applications received from various borrowers.
          </p>
          <p>
      ...
      <div className="mb-6" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm">
          ...
          <li>I acknowledge that my Name, details of Permanent Account Number (PAN), Aadhaar Card or of any other Address and Identity proof are obtained by the Service provider and Lender from the materials I have submitted in the website paisaasaarthi.com as part of my profile and loan application for review with my consent.</li>
